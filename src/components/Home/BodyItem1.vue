<template>
<div>
    <Divider orientation="left" style="font-weight:bold;">每日推荐</Divider>

    <div style="float:left;">
        <img src="@/assets/4.jpg" alt="" width="200px" height="20%"> 
    </div>
        ...
        <div v-if=" i%2 == 0">
            ...
            <Card class="cards" >
                <div style="text-align:center" @click="iteminfo(item.imgurl)">
                    <img :src="require('@/assets/'+item.imgurl+'.jpg')" alt="" class="images">
                    <h3>{{item.desc}}</h3>
                </div>
            </Card>
...
<script>
    ...
    export default {
        ...
        created(){
            axios.post('/getItem','每日推荐').then(res => {
